...
Shader "Shadertoy/SeaWave" { //https://www.shadertoy.com/view/Ms2SD1
    Properties{
        iMouse ("Mouse Pos", Vector) = (100, 100, 0, 0)
		SEA_BASE("Sea Base color", Color)  =(0.1, 0.19, 0.22, 1)
		SEA_WATER_COLOR("Sea Water color", Color)  =(0.8, 0.9, 0.6, 1)
    }
	...
	vec3 getSeaColor(vec3 p, vec3 n, vec3 l, vec3 eye, vec3 dist) {  
		...
		float temp = specular(n,l,eye,60.0);
    ...
    vec4 main(vec2 fragCoord) {
		...
		// post
		vec4 fragColor = vec4(pow(color,vec3(0.75,0.75,0.75)), 1.0);
        return fragColor;
    }
